...
import { IonContent, ViewDidLeave, ViewWillEnter } from '@ionic/angular/standalone';
...
import { UserSelectionFooterComponent } from "@pages/setup/user-selection/user-selection-footer/user-selection-footer.component";

@Component({
  selector: 'lp-user-selection',
  templateUrl: './user-selection.page.html',
  styleUrls: ['./user-selection.page.scss'],
  imports: [IonContent, CommonModule, FormsModule, HeaderComponent, AddPlayerInputComponent, PlayerListComponent, UserSelectionFooterComponent],
})
